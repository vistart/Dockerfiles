...
- Note: The images built based on this dockerfiles will not be updated temporarily because the travis-ci quota has been used up.
If you approve of my work and hope that I can continue it, [please donate to me](https://paypal.me/vistart). Thank you!
...
- 11.1-runtime-ubuntu18.04 (cuda 11.1.1, nccl 2.8.3)
- 11.1-devel-ubuntu18.04 (cuda 11.1.1, nccl 2.8.3)
- 11.1-cudnn8-runtime-ubuntu18.04 (cuda 11.1.1, nccl 2.8.3, cudnn 8.0.5.39)
- 11.1-cudnn8-devel-ubuntu18.04 (cuda 11.1.1, nccl 2.8.3, cudnn 8.0.5.39)
- 11.1-cudnn8-tensorrt7-devel-ubuntu18.04, 11.0-ubuntu18.04 (cuda 11.1.1, nccl 2.8.3, cudnn 8.0.5.39, tensorrt 7.2.1.6)
...
- 11.1-cudnn8-runtime-ubuntu16.04 (cuda 11.1.1, nccl 2.7.8, cudnn 8.0.5.39)
- 11.1-cudnn8-devel-ubuntu16.04 (cuda 11.1.1, nccl 2.7.8, cudnn 8.0.5.39)
- 11.1-cudnn8-tensorrt7-devel-ubuntu16.04 (cuda 11.1.1, nccl 2.7.8, cudnn 8.0.5.39, tensorrt 7.2.1.6)

# CUDA 11.0 (CUDA 11.0)
## Ubuntu 20.04
- 11.0-base-ubuntu20.04 (cuda 11.0.3)
- 11.0-runtime-ubuntu20.04 (cuda 11.0.3, nccl 2.8.3)
- 11.0-devel-ubuntu20.04 (cuda 11.0.3, nccl 2.8.3)
- 11.0-cudnn8-runtime-ubuntu20.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39)
- 11.0-cudnn8-devel-ubuntu20.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39)
- 11.0-cudnn8-tensorrt7-devel-ubuntu20.04, 11.0-ubuntu20.04, latest (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39, tensorrt 7.2.1.6)

## Ubuntu 18.04
- 11.0-base-ubuntu18.04 (cuda 11.0.3)
- 11.0-runtime-ubuntu18.04 (cuda 11.0.3, nccl 2.8.3)
- 11.0-devel-ubuntu18.04 (cuda 11.0.3, nccl 2.8.3)
- 11.0-cudnn8-runtime-ubuntu18.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39)
- 11.0-cudnn8-devel-ubuntu18.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39)
- 11.0-cudnn8-tensorrt7-devel-ubuntu18.04, 11.0-ubuntu18.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39, tensorrt 7.2.1.6)

## Ubuntu 16.04
- 11.0-base-ubuntu16.04 (cuda 11.0.3)
- 11.0-runtime-ubuntu16.04 (cuda 11.0.3, nccl 2.8.3)
- 11.0-devel-ubuntu16.04 (cuda 11.0.3, nccl 2.8.3)
- 11.0-cudnn8-runtime-ubuntu16.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39)
- 11.0-cudnn8-devel-ubuntu16.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39)
- 11.0-cudnn8-tensorrt7-devel-ubuntu16.04 (cuda 11.0.3, nccl 2.8.3, cudnn 8.0.5.39, tensorrt 7.2.1.6)
...
- 10.2-runtime-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3)
- 10.2-cudnn7-runtime-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32)
- 10.2-devel-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3)
- 10.2-cudnn7-devel-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32)
- 10.2-cudnn7-tensorrt6-devel-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32, tensorrt 6.0.1.8) (No longer updated)
- 10.2-cudnn7-tensorrt7-devel-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32, tensorrt 7.0.0.11)
- 10.2-cudnn8-runtime-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 8.0.5.39)
- 10.2-cudnn8-devel-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 8.0.5.39)
- 10.2-cudnn8-tensorrt7-devel-ubuntu18.04, 10.2-ubuntu18.04 (cuda 10.2.89, nccl 2.8.3, cudnn 8.0.5.39, tensorrt 7.1.3.4)

## Ubuntu 16.04
- 10.2-base-ubuntu16.04 (cuda 10.2.89)
- 10.2-runtime-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3)
- 10.2-cudnn7-runtime-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32)
- 10.2-devel-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3)
- 10.2-cudnn7-devel-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32)
- 10.2-cudnn7-tensorrt6-devel-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32, tensorrt 6.0.1.8) (No longer updated)
- 10.2-cudnn7-tensorrt7-devel-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 7.6.5.32, tensorrt 7.0.0.11)
- 10.2-cudnn8-runtime-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 8.0.5.39)
- 10.2-cudnn8-devel-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 8.0.5.39)
- 10.2-cudnn8-tensorrt7-devel-ubuntu16.04, 10.2-ubuntu16.04 (cuda 10.2.89, nccl 2.8.3, cudnn 8.0.5.39, tensorrt 7.1.3.4)
...
- 10.1-runtime-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3)
- 10.1-cudnn7-runtime-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3, cudnn 7.6.5.32)
- 10.1-cudnn8-runtime-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3, cudnn 8.0.5.39)
- 10.1-devel-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3)
- 10.1-cudnn7-devel-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3, cudnn 7.6.5.32)
- 10.1-cudnn8-devel-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3, cudnn 8.0.5.39)
- 10.1-cudnn7-tensorrt6-devel-ubuntu18.04, 10.1-ubuntu18.04 (cuda 10.1.243, nccl 2.8.3, cudnn 7.6.5.32, tensorrt 6.0.1.5) (No longer updated)

## Ubuntu 16.04
- 10.1-base-ubuntu16.04 (cuda 10.1.243)
- 10.1-runtime-ubuntu16.04 (cuda 10.1.243, nccl 2.8.3)
- 10.1-cudnn7-runtime-ubuntu16.04 (cuda 10.1.243, nccl 2.8.3, cudnn 7.6.5.32)
- 10.1-cudnn8-runtime-ubuntu16.04 (cuda 10.1.243, nccl 2.8.3, cudnn 8.0.4.30)
- 10.1-devel-ubuntu16.04 (cuda 10.1.243, nccl 2.8.3)
- 10.1-cudnn7-devel-ubuntu16.04 (cuda 10.1.243, nccl 2.8.3, cudnn 7.6.5.32)
- 10.1-cudnn8-devel-ubuntu16.04 (cuda 10.1.243, nccl 2.8.3, cudnn 8.0.4.30)
