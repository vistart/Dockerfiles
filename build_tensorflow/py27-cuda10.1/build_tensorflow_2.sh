docker run -itd --runtime=nvidia --rm --name build_tensorflow_2_py27_cuda10.1 -w /root/tensorflow -v "$PWD":/mnt -e HOST_PERMS="$(id -u):$(id -g)" vistart/build_tensorflow:py27-cuda10.1
...
docker stop build_tensorflow_2_py27_cuda10.1
