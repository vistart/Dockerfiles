docker run -itd --runtime=nvidia --rm --name build_tensorflow_2_py27_cuda10.0 -w /root/tensorflow -v "$PWD":/mnt -e HOST_PERMS="$(id -u):$(id -g)" vistart/build_tensorflow:py27-cuda10.0
