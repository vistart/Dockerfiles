docker run -itd --runtime=nvidia --rm --name build_tensorflow_1_py36_cuda10.0 -w /root/tensorflow -v "$PWD":/mnt -e HOST_PERMS="$(id -u):$(id -g)" vistart/build_tensorflow:py36-cuda10.0
...
docker stop build_tensorflow_1_py36_cuda10.0
