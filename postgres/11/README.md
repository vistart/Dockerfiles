...
基于 `postgres:11` 官方镜像构建，包含多个常用扩展。
...
# 启用扩展
docker exec postgres11 psql -U root -d test_db -c "CREATE EXTENSION IF NOT EXISTS postgis;"
docker exec postgres11 psql -U root -d test_db -c "CREATE EXTENSION IF NOT EXISTS pgvector;"
```
